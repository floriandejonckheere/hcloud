...
ActiveModel::Type.register(:floating_ip_price, HCloud::ResourceType.Type("HCloud::Prices::FloatingIP"))
ActiveModel::Type.register(:floating_ip_prices, HCloud::ResourceType.Type("HCloud::Prices::FloatingIPs"))
ActiveModel::Type.register(:image, HCloud::ResourceType.Type("HCloud::Image"))
ActiveModel::Type.register(:image_price, HCloud::ResourceType.Type("HCloud::Prices::Image"))
...
ActiveModel::Type.register(:load_balancer_type_price, HCloud::ResourceType.Type("HCloud::Prices::LoadBalancerType"))
...
ActiveModel::Type.register(:server_backup_price, HCloud::ResourceType.Type("HCloud::Prices::ServerBackup"))
ActiveModel::Type.register(:server_type, HCloud::ResourceType.Type("HCloud::ServerType"))
ActiveModel::Type.register(:server_type_price, HCloud::ResourceType.Type("HCloud::Prices::ServerType"))
...
ActiveModel::Type.register(:traffic_price, HCloud::ResourceType.Type("HCloud::Prices::Traffic"))
ActiveModel::Type.register(:volume, HCloud::ResourceType.Type("HCloud::Volume"))
ActiveModel::Type.register(:volume_price, HCloud::ResourceType.Type("HCloud::Prices::Volume"))
