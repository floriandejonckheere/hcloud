...
RSpec.describe HCloud::Creatable do
  ...
  describe "#create" do
    subject(:resource) { resource_class.new(id: nil, name: "my_resource", description: "my_description", created: nil, sibling: sibling, child: child1, children: [child0, child1]) }
